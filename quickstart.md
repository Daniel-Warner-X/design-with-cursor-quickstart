...
5. Create a **design_path.md** file to serve as a reference and record of your design decisions. This helps maintain context between sessions as well as tools. This can also help you recover when you need yo restart chat sessions. This file can be kept up to date automatically by Cursor. I prefer this method to creating a Cursor rule for design context. Cursor is good at curating what context it needs from this file at the right time and using it to inform prompts.
